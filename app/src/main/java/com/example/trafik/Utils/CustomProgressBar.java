package com.example.trafik.Utils;
...
public class CustomProgressBar extends View {
    ...
    private final int mBarColorStandard = 0xff009688; //stylish blue 00574B

    private int foregroundProgressColor = R.color.beyazimsi;
    private int backgroundProgressColor = R.color.beyazimsi;
